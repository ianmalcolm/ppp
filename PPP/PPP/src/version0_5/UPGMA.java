 ...
 */
public class UPGMA {
	ArrayList<TaxChar> taxa;		// the array of all PPPs
	int count;						// count the number of PPPs in taxa
	TaxChar[] fixTaxa;				// the array for implementing the UPGMA
	ArrayList<Pair> taxaPair;		// the array list of pair of PPP.
	/*
