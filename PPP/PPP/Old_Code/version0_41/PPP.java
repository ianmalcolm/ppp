 ...
 * 	Next Tasks: implement DPA!
 * 	Notes:	In version 0.41, the DPA firstly creates all the values of the every position with
 * 			all four directions, then replace them one by one.
 */
...
public class PPP {
	...
	private void displayFinal(){
		...
		System.out.println("The smallest state value is " + bestStateValue());
	}
	/*
