...
\abstract{
Testing of autonomous robotics is a difficult task and as they become more commonly applied to real world problems, it is increasingly important that we are confident in their safe behaviour. Hand-crafting test situations is time consuming and can not hope to cover a wide range of situations nor unexpected occurrences. Previous work has produced automatic generation tools to produce large numbers of diverse test case problems. Further work, however, is required to produce and ensure diverse environments in these test cases. Furthermore, improvements to these generators may improve the ability of the environments themselves to discover faults in the platform and algorithms of autonomous robotics and vehicles, such that they are caught and rectified at an experimental stage.}
