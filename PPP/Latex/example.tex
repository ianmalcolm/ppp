...
\section{Video}
\begin{description}
  \wwwr{http://youtu.be/s04nZHtI8jg}{Marc van Dongen's Introduction to
    \LaTeX} Fifteen minutes and 50 seconds of advertisement and gentle
  introduction to the working model and basic features.
\end{description}
...
\lstinline|\ACS|, \lstinline|\SWE|, \lstinline|\MIT|, or
\lstinline|\SCSE| (\lstinline|\MIP| and \lstinline|\GTC| are available
for historical purposes).  These take no parameter.
